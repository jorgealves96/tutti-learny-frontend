...
import 'models/path_report_model.dart'; // Make sure this model is imported
...
class _ReportStatusScreenState extends State<ReportStatusScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.reportStatusScreen_title),
      ),
      body: FutureBuilder<PathReport?>(
        ...
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data == null) {
            return Center(
              child: Text(l10n.reportStatusScreen_noReportFound),
            );
          }
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  l10n.reportStatusScreen_statusLabel(
                    statusText,
                  ),
                ...
                Text(
                  isResolved
                      ? report.resolutionMessage ??
                            l10n
                                .reportStatusScreen_resolvedMessageDefault
                ...
                if (isResolved && !isAcknowledged) ...[
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      l10n.reportStatusScreen_acknowledgeButton,
                    ),
                  ),
                ],
              ],
